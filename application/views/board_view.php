<div class="container">
    ...
    <table class="table table-hover">
		...
		<tbody>
			...
			<tr class="clickable-row" data-href="http://pyoungsub.devleaguer.com///codeigniter/mement/details/<?php echo $row['notice_id']?>">
...
<div class="modal fade" id="write_modal">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="post" action="http://pyoungsub.devleaguer.com///codeigniter/mement/comment">
            <!-- write_modal body -->
